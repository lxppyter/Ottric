...
export class PortalController {
  ...
  @ApiOperation({
    ...
    description: 'Get all projects for the organization with summary stats.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Get all versions for a product.',
  })
  @UseGuards(JwtAuthGuard)
  ...
  @ApiOperation({
    ...
    description: 'Get the ingested SBOM JSON.',
  })
  async downloadSbom(
  ...
  @ApiOperation({
    summary: 'Get VEX Statements',
    description: 'List all VEX statements for this version.',
  })
  async downloadVex(
    @Param('product') product: string,
    @Param('version') version: string,
  ...
  @ApiOperation({
    ...
    description: 'Get full audit pack (Scorecard, VEX, SBOM summary).',
  })
  async getAuditPack(
    @Param('product') product: string,
    @Param('version') version: string,
  ...
  @ApiOperation({
    ...
    description: 'Download Security Audit Report as PDF.',
  })
