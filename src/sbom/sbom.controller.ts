...
export class SbomController {
  constructor(
    ...
    private readonly vexService: VexService,
  ) {}
  ...
  @ApiOperation({
    summary: 'Upload SBOM',
    description: 'Upload CycloneDX JSON/XML file',
  })
  // ... annotations ...
  ...
  async uploadSbom(@UploadedFile() file: any, @Req() req) {
    ...
    try {
      ...
      // Trigger Vulnerability Correlation (Scanning)
      ...
      throw new BadRequestException(
        'Invalid JSON or Ingestion Failed: ' + e.message,
      );
    }
  }
