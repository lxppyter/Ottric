...
export class UsersController {
  ...
  async getProfile(@Request() req) {
      ...
      if (!user) {
          console.warn(`Profile requested for non-existent user: ${req.user.email}`);
  ...
  @Get('notifications')
  @UseGuards(JwtAuthGuard)
  @ApiOperation({ summary: 'Get Notifications', description: 'Get personal notifications.' })
  ...
  @UseGuards(JwtAuthGuard)
  @ApiOperation({ summary: 'Mark Notification Read', description: 'Mark a notification as read.' })
